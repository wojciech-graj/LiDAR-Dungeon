...
function g_ui_render()
   ...
   -- Draw compass
   local dir_y_comp = g_exit_pos_y - player.pos_y
   local dir_x_comp = g_exit_pos_x - player.pos_x
   local dir_comp_mul = 4 / math.sqrt(dir_y_comp * dir_y_comp + dir_x_comp * dir_x_comp)
   line(220, 4, 220 + dir_x_comp * dir_comp_mul, 4 + dir_y_comp * dir_comp_mul, 2)
...
function g_map_gen()
   ...
   g_exit_pos_x = math_random(exit_room[1] + 2, exit_room[3] - 2)
   g_exit_pos_y = math_random(room[2] + 2, room[4] - 2)
   mset(
      g_exit_pos_x,
      g_exit_pos_y,
      32
